...
```toml
[dependencies]
ratkit = { version = "0.2.10", features = ["all"] }
```
...
```toml
[dependencies]
ratkit = { version = "0.2.10", default-features = false, features = ["markdown-preview", "tree-view", "button"] }
```
...
```toml
ratkit = { version = "0.2.10", default-features = false, features = ["tree-view", "toast"] }
```
