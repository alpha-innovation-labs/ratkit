		...
		<header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
			<nav className="container max-w-none flex h-14 items-center justify-between pl-0 pr-4 sm:h-16 sm:pl-0 sm:pr-6 lg:pr-8">
				...
				<div className="flex items-center md:w-[272px] lg:w-[290px]">
					...
					<NavbarDivider className="hidden md:block h-16 ml-auto" />
				</div>
				...
				<div className="hidden items-center gap-4 sm:flex lg:gap-6">
					...
					<Button variant="ghost" className="gap-2 p-4" asChild>
						<Link
							href="https://github.com/Alpha-Innovation-Labs/ratkit"
							target="_blank"
...
export const GithubIcon = ({ className }: GithubIconProps) => {
	return (
		<svg
			className={cn(
				"h-4 w-4 text-muted-foreground transition-all duration-300 group-hover:text-[#ef4444]",
				className,
			)}
